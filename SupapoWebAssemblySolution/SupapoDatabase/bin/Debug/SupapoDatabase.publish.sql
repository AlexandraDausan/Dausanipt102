/*
Deployment script for SupapoWADatabase
...
GO
:setvar DatabaseName "SupapoWADatabase"
:setvar DefaultFilePrefix "SupapoWADatabase"
...
END
GO
PRINT N'Creating Procedure [dbo].[DisplayProfile]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1fc06a5a-14ed-4658-bd2c-03427435c91c')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1fc06a5a-14ed-4658-bd2c-03427435c91c')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c8b9a9d1-15a0-4fea-b8f8-06cbf1971f6f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c8b9a9d1-15a0-4fea-b8f8-06cbf1971f6f')
